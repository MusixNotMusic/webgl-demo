...
import { radarTestSet } from "./Constants.js";

import BaseModelLayer from "./BaseModelLayerV2.js";
    ...
    return new Promise((resolve, reject) => {
      loader.load( '/model/fbx/radar2.fbx',  ( model ) => {
        ...
        this.data.forEach((item, index) => {
          ...
          this.setCoordination(custom, { lon: item.lon, lat: item.lat}, 0.001);

          // custom.add(new THREE.AxesHelper(500));
